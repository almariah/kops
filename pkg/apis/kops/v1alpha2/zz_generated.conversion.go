...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec,
		Convert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec,
...
func autoConvert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec(in *AdditionalRoutesSpec, out *kops.AdditionalRoutesSpec, s conversion.Scope) error {
	out.CIDR = in.CIDR
	out.Instance = in.Instance
	out.VpcPeeringConnection = in.VpcPeeringConnection
	return nil
}

// Convert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec is an autogenerated conversion function.
func Convert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec(in *AdditionalRoutesSpec, out *kops.AdditionalRoutesSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec(in, out, s)
}

func autoConvert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec(in *kops.AdditionalRoutesSpec, out *AdditionalRoutesSpec, s conversion.Scope) error {
	out.CIDR = in.CIDR
	out.Instance = in.Instance
	out.VpcPeeringConnection = in.VpcPeeringConnection
	return nil
...
// Convert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec is an autogenerated conversion function.
func Convert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec(in *kops.AdditionalRoutesSpec, out *AdditionalRoutesSpec, s conversion.Scope) error {
	return autoConvert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec(in, out, s)
}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.AdditionalRoutes != nil {
		...
		*out = make([]kops.AdditionalRoutesSpec, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_AdditionalRoutesSpec_To_kops_AdditionalRoutesSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.AdditionalRoutes != nil {
		in, out := &in.AdditionalRoutes, &out.AdditionalRoutes
		*out = make([]AdditionalRoutesSpec, len(*in))
		for i := range *in {
			if err := Convert_kops_AdditionalRoutesSpec_To_v1alpha2_AdditionalRoutesSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
