...
var federationsKind = schema.GroupVersionKind{Group: "kops", Version: "v1alpha2", Kind: "Federation"}
...
func (c *FakeFederations) List(opts v1.ListOptions) (result *v1alpha2.FederationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(federationsResource, federationsKind, c.ns, opts), &v1alpha2.FederationList{})
